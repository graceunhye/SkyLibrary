	...
	var m_LoginStr ='<h2 class="login_title">사서 로그인</h2>                                                                                         '
		...
		+'				<td width="300"><input type="text" class="input" name="managerID" size="38" placeholder=" 아이디를 입력해주세요."></td>                    '
		+'			</tr>                                                                                                                             '
		+'			<tr height="50" class="login_txt">                                                                                                '
		+'				<td align="right" class="login_input"><span class="point">*</span>비밀번호:</td>                                                '
		+'				<td><input type="password" name="managerPW" class="input" size="38" placeholder=" 비밀번호를 입력해주세요."></td>                         '
		+'			</tr>                                                                                                                             '
