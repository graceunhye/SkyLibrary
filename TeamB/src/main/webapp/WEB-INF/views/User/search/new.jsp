...
<html>
	<head>
		...
		<link rel="stylesheet" href="/css/search/new.css" type="text/css"/>
			...
			<section id="section">
				<nav class="left_menu">
					<ul>
						...
						<a href="/search/new"><li class="on left_menu_sub">신착도서</li></a>
									...
									<table width="800px">
										<tr>
											<td rowspan="4" width="15%" align="center">
												<a href="/search/newView?isbn=${list.bookISBN}"><img src="${list.bookCoverImg}" alt="${list.bookSubject}" width="82px"></a>
											</td>
											<td colspan="2"><a href="/search/newView?isbn=${list.bookISBN}"><b>${list.bookSubject}</b></a></td>
										</tr>
										<tr>
								...
								<c:forEach begin="${paging.startPage}" end="${paging.endPage}" var="p">
									...
									<c:choose>
										...
										<c:when test="${p != paging.nowPage}">
											<a href="/search/new?nowPage=${p }&cntPerPage=${paging.cntPerPage}">${p }</a>
										</c:when>
									</c:choose>
								</c:forEach>
