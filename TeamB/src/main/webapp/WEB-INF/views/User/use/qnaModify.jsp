				...
				<div class="section">
					...
					<div class="content">
						<div class="qInsertTableWrap">
							<form action="/use/qna/modifyOk" method="post">
								<table class="qInsertTable">
									<tr>
										<th align="center" width="100">제목</th>
										<td class="qInsertTableTd">
											<input type="text" size="115" value="${q.questionTitle }"  name="questionTitle">
										</td>
									</tr>
									<tr>
										<th>내용</th>
										<td width="800" height="400" class="qInsertTableTd">
											<textarea name="questionBody" cols="120" rows="25" style="resize:none">${q.questionBody }</textarea>
										</td>
									</tr>
									<tr>
										<td colspan="2">
											<div align="right">
												...
												<input type="submit" value="수정하기" class="qna_btn">
